...
public class HL7v2MessageBuilderUtilsTest {
    ...
    public void testCreateZxtA01() throws IOException, HL7Exception {
        InputStream registerClientJsonPayloadStream = HL7v2MessageBuilderUtilsTest.class.getClassLoader().getResourceAsStream("register_client.json");
        ...
        InputStream streamExpectedHl7Message = HL7v2MessageBuilderUtilsTest.class.getClassLoader().getResourceAsStream("hl7v2_registration_message");
        ...
        Assert.assertEquals(expectedHl7Message, HL7v2MessageBuilderUtils.encodeZxtMessage(zxtA01));
    }
    ...
    public void testParsingAndEncodingZxtA01Message() throws IOException, HL7Exception {
        InputStream streamHl7Message = HL7v2MessageBuilderUtilsTest.class.getClassLoader().getResourceAsStream("hl7v2_registration_message");
        ...
        String encodedMessageString = HL7v2MessageBuilderUtils.encodeZxtMessage(zxtA01);

        Assert.assertEquals(expectedHl7MessageString, encodedMessageString);
    }

    /**
     * Tests creating of ZXT_A40.
     */
    @Test
    public void testCreateZxtA40() throws IOException, HL7Exception {
        InputStream clientsConflictsResolutionJsonPayloadStream = HL7v2MessageBuilderUtilsTest.class.getClassLoader().getResourceAsStream("clients_conflicts_resolution.json");

        Assert.assertNotNull(clientsConflictsResolutionJsonPayloadStream);
        ...
        InputStream streamExpectedHl7Message = HL7v2MessageBuilderUtilsTest.class.getClassLoader().getResourceAsStream("hl7v2_conflicts_resolutions_message");
        Assert.assertNotNull(streamExpectedHl7Message);

        String expectedHl7Message = IOUtils.toString(streamExpectedHl7Message).replaceAll("\\n", "\r");
        Assert.assertEquals(expectedHl7Message, HL7v2MessageBuilderUtils.encodeZxtMessage(zxtA40));
    }

    /**
     * Tests parsing ZxtA40Message.
     */
    @Test
    public void testParsingAndEncodingZxtA40Message() throws IOException, HL7Exception {
        InputStream streamHl7Message = HL7v2MessageBuilderUtilsTest.class.getClassLoader().getResourceAsStream("hl7v2_conflicts_resolutions_message");

        Assert.assertNotNull(streamHl7Message);

        String expectedHl7MessageString = IOUtils.toString(streamHl7Message).replaceAll("\\n", "\r");

        ZXT_A40 zxtA40 = HL7v2MessageBuilderUtils.parseZxtA40Message(expectedHl7MessageString);

        Assert.assertNotNull(zxtA40);

        String encodedMessageString = HL7v2MessageBuilderUtils.encodeZxtMessage(zxtA40);
