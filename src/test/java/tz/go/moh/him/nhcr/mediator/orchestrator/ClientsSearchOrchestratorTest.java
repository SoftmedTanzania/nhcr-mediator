...
public class ClientsSearchOrchestratorTest extends BaseOrchestratorTest {

    /**
     * The orchestrator.
     */
    private final ActorRef orchestrator = system.actorOf(Props.create(ClientsSearchOrchestrator.class, configuration));
    ...
    public void testWithMissingTokenRequest() throws Exception {
        ...
        new JavaTestKit(system) {{
            ...
            InputStream stream = ClientsSearchOrchestratorTest.class.getClassLoader().getResourceAsStream("clients_search_request.json");
