...
public class RitaClientsSearchOrchestratorTest extends BaseOrchestratorTest {
    ...
    public void testRequest() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = RitaClientsSearchOrchestratorTest.class.getClassLoader().getResourceAsStream("rita_clients_search_request.json");
